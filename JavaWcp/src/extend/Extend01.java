...
public class Extend01 {
	public static void main(String[] args) {
		...
		System.out.println("Humanクラスのメソッド：名前は,"
				+ sugimoto.getName());
		
		Student sato = new Student("佐藤", 17, 70);
		System.out.println("Humanクラスのメソッド:名前は、"
				+ sato.getName());
		System.out.println("Studentクラスのメソッド:プロフィールを紹介します。" 
				+ sato.getStudentProfil());
		...
		System.out.println("Employeeクラスのメソッド:Profile紹介します。"
				+ tanaka.getEmployeeProfile());
